function print_membership_functions_plot(var, range, count, type, plotname, filename, scale)
    ...
    switch var
        case 'error'
            ...
            ylabel('$\mu(e_h)$', 'Interpreter', 'latex', 'FontSize', 12);
            legend('negative-big', 'zero', 'positive-big', ...
                   'Interpreter', 'latex', 'FontSize', 10, 'Location', 'southeast')
        case 'rate'
            xlabel('$\dot{h}, \rm m/s$', 'Interpreter', 'latex', 'FontSize', 12);
            ylabel('$\mu(\dot{h})$', 'Interpreter', 'latex', 'FontSize', 12);
            legend('negative-big', 'zero', 'positive-big', ...
                   'Interpreter', 'latex', 'FontSize', 10, 'Location', 'southeast')
        case 'speed'
            xlabel('$\omega$, \rm rad/s', 'Interpreter', 'latex', 'FontSize', 12);
            ylabel('$\mu(\omega)$', 'Interpreter', 'latex', 'FontSize', 12);
            legend('negative-big', 'negative-middle', 'zero', 'positive-middle', 'positive-big', ...
                   'Interpreter', 'latex', 'FontSize', 10, 'Location', 'southeast')
    end
